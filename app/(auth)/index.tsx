...
//         console.error("Cannot sync: Invalid user data");
//         return false;
//      }
...
//            full_name:
//               `${userData.firstName || ""} ${userData.lastName || ""}`.trim(), // Combine first and last names
//            username: userData.email?.split("@")[0] || `user_${Date.now()}`, // Generate username from email
//            updates_at: new Date().toISOString(), // Use updates_at for the last update timestamp
//         };
...
//            const newUserData = {
//               ...supabaseUserData,
//               created_at: new Date().toISOString(), // Add created_at for new users
//            };
...
//   // Direct navigation effect - runs when user info is available
//   useEffect(() => {
//      let isMounted = true;

//      const handleNavigation = async () => {
//         if (userInfo && !isSyncingDb && isMounted) {
//            try {
...
//               } else {
//                  // Even if sync fails, navigate with a warning
...
//         // If we got a proper session, great!
//         if (result.createdSessionId) {
//            console.log("Setting session active");
//            await result.setActive({ session: result.createdSessionId });
//            // User state will update, triggering our effects
//         }
      ...
      <SafeAreaView style={styles.container}>
         <View style={styles.contentContainer}>
            ...
            <View style={styles.textContainer}>
               ...
               <Text style={styles.subtitle}>
                Guarantee your parking spot in advance. Parkhive allows you to book parking with just a few taps.
