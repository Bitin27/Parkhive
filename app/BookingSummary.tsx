...
//                <DetailRow
//                   label="Arriving Time"
//                   value={`${date} | ${parkingDetails.formattedArrivalTime}`}
//                />
//                <DetailRow
//                   label="Exit Time"
//                   value={
//                      parkingDetails.isExitTimeProvided
//                         ? `${date} | ${parkingDetails.formattedExitTime}`
...
const BookingSummary: React.FC<BookingSummaryProps> = ({
   ...
   console.log("This the from bookingSummary", userId);
   console.log("This the from bookingSummary", userEmail);
   // Helper function to safely parse dates and times
   const parseDateTime = (dateStr?: string, timeStr?: string): Date => {
      const now = new Date();
   ...
   const handleStripePay = () => {
      // Only allow Stripe payment if exit time is provided
      if (parkingDetails.isExitTimeProvided) {
         router.push({
            pathname: "/stripe",
            params: {
               userId,
         ...
         <View style={styles.paymentButtonsContainer}>
            <TouchableOpacity
               style={[
                  ...
                  styles.stripeButton,
                  !parkingDetails.isExitTimeProvided && styles.disabledButton
               ]}
               onPress={handleStripePay}
               disabled={!parkingDetails.isExitTimeProvided || createBookingMutation.isPending}
            >
               <Text style={[
                  styles.paymentButtonText,
                  !parkingDetails.isExitTimeProvided && styles.disabledButtonText
               ]}>
                  Pay With Stripe
               </Text>
            </TouchableOpacity>
