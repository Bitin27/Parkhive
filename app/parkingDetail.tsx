...
const ParkingDetailsScreen = () => {
   ...
   const parkingData = {
      ...
      price: parseFloat(params.price) || 5.0,
      description: params.description || "No description available",
      // Use the image from params if available, otherwise use placeholder
      imageUrl: params.image || null,
      operatorName: "Parking Manager",
      operatorImage: require("../assets/images/parkingmanager.png"), // Use a default image
   };
   ...
   return (
      <SafeAreaView style={styles.container}>
         ...
         {/* Main Content */}
         <ScrollView style={styles.scrollView} bounces={false}>
            {/* Image Display - Single Image if from params, otherwise default image slider */}
            <View style={styles.swiperContainer}>
               {parkingData.imageUrl ? (
                  ...
                  >
                     {[1, 2, 3].map((_, index) => (
                        <Image
                           key={index}
                           source={require("../assets/images/Bishalbazar.png")}
                           style={styles.image}
                           resizeMode="cover"
                        />
                     ))}
            ...
            <View style={styles.content}>
               {/* Title Section */}
               <View style={styles.typeContainer}>
                  <Text style={styles.type}>Parking</Text>
                  <View style={styles.ratingContainer}>
                     <Ionicons name="star" size={16} color="#FFD700" />
                     <Text style={styles.rating}>
                        {parkingData.rating} ({parkingData.reviews} reviews)
