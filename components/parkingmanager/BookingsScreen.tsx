...
//   // Improved format date function to handle different date formats
...
//     try {
//       // Try parsing as ISO date first (for created_at, estimated_end_time, actual_end_time)
//       const date = new Date(dateString);
...
//       // If it's not a valid date, it might be a time string (for start_time)
//       // Try to create a date by combining today's date with the time
...
//       // If we can't parse it as a time either, return the original string
//       return dateString;
//     } catch (error) {
...
//   // Format time specifically for time fields (start_time)
//   const formatTimeOnly = (timeString: string | null | undefined) => {
//     if (!timeString) return "N/A";
    
//     try {
//       // For time with timezone fields
...
//                     {item.actual_end_time
//                       ? formatTimeOnly(item.actual_end_time)
//                       : formatTimeOnly(item.estimated_end_time) +
//                       " (Est.)"}
//                   </Text>
//                 </View>
//                 <View style={styles.detailRow}>
...
//                     <Text style={styles.detailValue}>
//                       {formatTimeOnly(selectedBooking.start_time)}
//                     </Text>
//                   </View>
//                   <View style={styles.detailItem}>
//                     <Text style={styles.detailLabel}>Expected End:</Text>
//                     <Text style={styles.detailValue}>
//                       {formatDate(selectedBooking.estimated_end_time)}
//                     </Text>
//                   </View>
//                   {selectedBooking.actual_end_time && (
//                     <View style={styles.detailItem}>
...
//                       <Text style={styles.detailValue}>
//                         {formatDate(selectedBooking.actual_end_time)}
//                       </Text>
//                     </View>
//                   )}
//                 </View>
...
type Booking = {
  created_at: string;
  zone_id: string;
  start_time: string; // This is a time with time zone field
  user_id: number;
  vehicle_id: string;
  slot_id: number;
  estimated_end_time: string; // This is a timestamp with time zone field
  actual_end_time: string | null;
  total_amount: number;
  additional_charges: number;
  payment_method: string;
