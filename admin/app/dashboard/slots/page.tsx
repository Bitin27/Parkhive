...
//         let query = supabase
//           .from('parking_slots')
//           .select('*, parking_sections(id, name)')
...
//     underReview: slots.filter(slot => slot.status === "Under Review").length,
//   }
...
//           <TabsTrigger value="occupied" onClick={() => setStatusFilter("Occupied")}>Occupied</TabsTrigger>
//           <TabsTrigger value="underReview" onClick={() => setStatusFilter("Under Review")}>Under Review</TabsTrigger>
//         </TabsList>
...
//           />
//         </TabsContent>
//         <TabsContent value="underReview" className="mt-0">
//           <SlotTable 
//             slots={slots} 
//             isLoading={isLoading} 
//             handlePriceChange={handlePriceChange}
...
// function SlotTable({ slots, isLoading, handlePriceChange, getStatusBadge }: SlotTableProps) {
